...
A gas meter reading estimation application using **Multiple Linear Regression (MLR)**. Allows loading data from CSV file, training a linear regression model, and comparing actual readings with estimated ones.
